        ...
        <div className='bg-[#003b2f]'>
            <div className='md:max-w-[95%] m-auto md:me-[2.5em] px-6'>
                <div className=" grid grid-cols-2 md:grid-cols-6 gap-7 md:gap-1 ">
                    ...
                    <div className='services'>
                        ...
                        <ul className="text-[12px] text-[#b1b4b6] md:w-20 flex flex-col gap-[.6em]">
                            <li>MirrorXTrade as a Service</li>
                        </ul>
                    </div>
                    ...
                    <div className='contact'>
                        ...
                        <ul className="text-[12px] text-[#b1b4b6] flex flex-col gap-[.6em]">
                            ...
                            <li>info@MirrorXTrade.com</li>
                            <li>support@MirrorXTrade.com</li>
                ...
                <div className="socials flex flex-col md:flex-row justify-between items-center gap-7 mt-[4.5em]">
                    ...
                    <div className="MirrorXTrade-license text-[12px] text-center smm:text-left mt-3 lg:w-[50%] lg:ms-[5rem]">
                        ...
                        <p className='text-[#b1b4b6]'>
                            MirrorXTrade USA, Inc. is licensed to engage in
                        ...
                        <p className='text-[#b1b4b6] text-[12px] my-2'>
                            All rights reserved © 2025 MirrorXTrade.
