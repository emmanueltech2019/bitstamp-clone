        ...
        <div className='bg-[#f2f2f2]'>
            ...
            <section className='md:max-w-[95%] m-auto sm:flex sm:items-center'>
                <div className='px-6 pt-24 md:pt-60 overflow-x-hidden'>
                    ...
                    <div className="start-staking my-4 smm:w-[470px]">
                        <button className="get-started text-[#03fc9d] bg-[#003b2f] hover:bg-[#03fc9d] hover:text-[#003b2f] w-full p-2 rounded font-semi-bold smm:w-[30%]">Start staking</button>
                    </div>

                    <div>
                        <small className='text-[#003b2f]'>Bitstamp Earn Staking is not available to customers in the UK, US, Singapore, Japan and Canada.</small>
                    </div>
                </div>
                        ...
                        <table className='desktop w-full'>
                            ...
                            <tbody className='tbody-des hidden md:block'>
                                <tr className='text-center border-b'>
                                    ...
                                    <td className='w-[280px] p-4'><button className="get-started text-[#03fc9d] bg-[#003b2f] hover:bg-[#03fc9d] hover:text-[#003b2f] w-[50%] p-2 rounded font-semi-bold">Stake</button></td>
                                </tr>
                                <tr className='text-center border-b'>
            ...
            <section className='bg-[#fff]'>
                <div className='px-6 sm:max-w-[716px] m-auto py-[3rem] md:py-[6rem]'>
                    <h2 className='text-[#003b2f] text-[30px] sm:text-[48px] font-GT font-bold mb-[2rem]'>
                        ...
                        <span>Staking with Bitstamp Earn</span>
                    </h2>
                    ...
                    <p className='text-[#003b2f] text-[17px] my-4'>
                        When staking with Bitstamp Earn, you maintain full
                        ownership of your crypto assets. Bitstamp does not
                        ...
                        network. Bitstamp acts as a service provider and charges
            ...
            <section className='bg-[#f2f2f2]'>
                <div className='sm:max-w-[726px] m-auto text-center p-6 sm:p-[6rem]'>
                    ...
                    <button type='submit' className='bg-[#003b2f] text-[#03fc9d] p-2 rounded w-full smm:w-[200px] m-auto my-[1rem]'>Start staking now</button>
