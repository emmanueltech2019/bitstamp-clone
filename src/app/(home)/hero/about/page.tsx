        ...
        <div>
                    ...
                    <div className='lg:flex relative'>
                        <div className='lg:w-[70%]'>
                            <div className="head-text sm:w-[90%] md:w-[83%] lg:w-[70%] mt-24 md:mt-60">
                                ...
                                <p className='text-[#303841] text-[18px] smm:text-[24px] font-GT font-bold my-[2rem] smm:w-[80%] lg:w-[59%]'>Security. Transparency. Regulation. The Mirror TradeX Way since 2011.</p>
                            </div>
                        ...
                        <div className='mt-[2.5rem] grid smm:grid-cols-2 md:grid-cols-1 gap-[3rem]'>
                            <div>
                                ...
                                <p className='text-[#003b2f] text-[17px]'>
                                    ...
                                    on Mirror TradeX are backed 100% and ready to be withdrawn
                    ...
                    <div className="team grid smm:grid-cols-2 lg:grid-cols-3 gap-[6em] smm:gap-[2em] smm:gap-y-[5rem]">
                        <div>
                            ...
                            <div className="text mt-[1.5rem] smm:grid-cols-2">
                                ...
                                <p className='text-[17px] text-[#fff] my-[2rem]'>
                                    B brings his unique background of integrating digital platforms with financial services to help Mirror TradeX welcome investors of all types to participate in the future of finance.
                                </p>
                        ...
                        <div>
                            ...
                            <div className="text mt-[1.5rem]">
                                ...
                                <p className='text-[17px] text-[#fff] my-[2rem]'>
                                    After gaining experience in various finance leadership roles, including corporate governance and control functions, Stephen is Mirror TradeX’s key person for financial expansion.
                                </p>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon text-[#fff]" width="32" height="32" data-v-f72832e9=""><path fill="currentColor" d="M12,0A12,12,0,1,0,24,12h0A12,12,0,0,0,12,0ZM8.64,17H6.3V9.52H8.64ZM7.41,8.6h0A1.31,1.31,0,0,1,7.15,6h.28a1.31,1.31,0,0,1,.28,2.6ZM18,17H15.35V13.15c0-1-.42-1.7-1.33-1.7a1.35,1.35,0,0,0-1.27.91,1.57,1.57,0,0,0-.06.61v4H10.07V9.52h2.62V10.7A2.41,2.41,0,0,1,15,9.46c1.67,0,3,1.08,3,3.39Z"></path></svg>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="text mt-[1.5rem]">
                                ...
                                <strong className='text-[14px] text-[#6b807a]'>CEO, Mirror TradeX USA & Global Chief Commercial Officer, Mirror TradeX</strong>
                        ...
                        <div>
                            ...
                            <div className="text mt-[1.5rem]">
                                ...
                                <p className='text-[17px] text-[#fff] my-[2rem]'>
                                    As the Chief People Officer, Bernice leads on developing the people and engagement agenda at Mirror TradeX, leading a diverse talent acquisition strategy and developing a dynamic distributed workforce culture as we enter new markets and our next decade of growth.
                                </p>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon text-[#fff]" width="32" height="32" data-v-f72832e9=""><path fill="currentColor" d="M12,0A12,12,0,1,0,24,12h0A12,12,0,0,0,12,0ZM8.64,17H6.3V9.52H8.64ZM7.41,8.6h0A1.31,1.31,0,0,1,7.15,6h.28a1.31,1.31,0,0,1,.28,2.6ZM18,17H15.35V13.15c0-1-.42-1.7-1.33-1.7a1.35,1.35,0,0,0-1.27.91,1.57,1.57,0,0,0-.06.61v4H10.07V9.52h2.62V10.7A2.41,2.41,0,0,1,15,9.46c1.67,0,3,1.08,3,3.39Z"></path></svg>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="text mt-[1.5rem]">
                                ...
                                <p className='text-[17px] text-[#fff] my-[2rem]'>
                                    James, a seasoned General Counsel with expertise in compliance, regulation, and operations across sectors like banking, cryptocurrency, funds, and real estate, oversees Mirror TradeX&#39;s legal compliance and brings over 15 years of extensive experience in financial services.
                                </p>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="icon text-[#fff]" width="32" height="32" data-v-f72832e9=""><path fill="currentColor" d="M12,0A12,12,0,1,0,24,12h0A12,12,0,0,0,12,0ZM8.64,17H6.3V9.52H8.64ZM7.41,8.6h0A1.31,1.31,0,0,1,7.15,6h.28a1.31,1.31,0,0,1,.28,2.6ZM18,17H15.35V13.15c0-1-.42-1.7-1.33-1.7a1.35,1.35,0,0,0-1.27.91,1.57,1.57,0,0,0-.06.61v4H10.07V9.52h2.62V10.7A2.41,2.41,0,0,1,15,9.46c1.67,0,3,1.08,3,3.39Z"></path></svg>
                            </div>
                        </div>
                ...
                <div className='md:max-w-[97%] m-auto p-7 pb-[5rem]'>
                    ...
                    <div className="entities grid smm:grid-cols-2 md:grid-cols-4 gap-[4rem] lg:gap-[9rem]">
                        <div className='text-[#f2f2f2]'>
                            <strong className='text-[16px] '>Mirror TradeX Europe S.A.</strong>.
                            <p>
                                40, avenue Monterey
                                L-2163 Luxembourg
                                Luxembourg
                        ...
                        <div className='text-[#f2f2f2]'>
                            <strong className='text-[16px] '>Mirror TradeX Ltd</strong>.
                            <p>
                                5 New Street Square
                                London EC4A 3TW
                                United Kingdom
                        ...
                        <div className='text-[#f2f2f2]'>
                            <strong className='text-[16px] '>Mirror TradeX UK Limited</strong>.
                            <p>
                        ...
                        <div className='text-[#f2f2f2]'>
                            <strong className='text-[16px] '>Mirror TradeX USA Inc</strong>.
                            <p>
            ...
            <section className='bg-[#2185D5]'>
                <div className='md:max-w-[47%] m-auto p-7 pb-[3rem] lg:py-[8rem]'>
                    ...
                    We believe that opening the world of finance opens opportunities for everyone. That’s why we provide easy access to the world of crypto to empower everyone to benefit from the next generation of finance. If this strikes a chord with you – then come and join the Mirror TradeX team.
                    </p>

                    <div className='text-center w-full smm:w-[140px] m-auto'>
                        <button className='text-[#fff] bg-[#303841] w-full p-[.4rem] rounded hover:bg-[#f2f2f2] hover:text-[#003b2f]'>Join the team</button>
                    </div>
                </div>
