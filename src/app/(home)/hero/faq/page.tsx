                        ...
                        <div>
                            ...
                            <Accordion title={<h2 className='font-GT font-bold text-[20px] text-[#003b2f]'>Can you prepare a Statement for my account balance and transactions?</h2>} answer={<div className="my-[2rem] text-[17px] text-[#003b2f] flex flex-col gap-5">
                                ...
                                <ul className=' list-disc px-[1.3rem]'>
                                    <li>
                                        every transaction (every buy, sell, deposit, withdraw, etc.) on your Mirror Trade account for the selected time period,
                                    </li>
                                    <li>
                                        your total Mirror Trade account balance, broken down into specific currencies, on a specified date.
                                    </li>
                                </ul>
                                <p>
                        ...
                        <div>
                            ...
                            <Accordion title={<h2 className="font-GT font-bold text-[20px] text-[#003b2f]">Why do I have to wait after placing an Instant Purchase</h2>} answer={
                                <div className="my-[2rem] text-[17px] text-[#003b2f] flex flex-col gap-5">
                                    ...
                                    <p>
                                        Alternatively, you may also fund your Mirror Trade account via an alternative transfer method such as SEPA transfer or International Wire Transfer, for which we do not have a reservation period implemented, and you should be able to withdraw your funds as soon as they are credited to your Mirror Trade account.
                                    </p>
                                </div>
                            } />
                        </div>
