    ...
    return (
        <div>
            <section className="bg-[#f2f2f2]">
                <div className='md:flex px-6 md:max-w-[95%] m-auto pt-[8rem]'>
                    <header>
                        <h1 className='text-[#003b2f] text-[27px] smm:text-[48px] font-GT font-bold'>FAQ</h1>
                    </header>
                    ...
                    <div>
                        ...
                        <Accordion title={<h2 className="font-GT font-bold text-[20px] text-[#003b2f]"></h2>} answer={
                            <div className="my-[2rem] text-[17px] text-[#003b2f] flex flex-col gap-5">
                                <p>
