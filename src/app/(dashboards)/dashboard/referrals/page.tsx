          ...
          <Card className="bg-[#04fb9d] p-3 rounded-lg shadow-md text-[#333333]">
            <CardContent>
              ...
              <Typography variant="body1" className="mb-6 text-[12px]">
                As an affiliate, you'll receive free access to a range of marketing tools and resources designed to help you promote our site and drive sales. We offer top commissions for every successful referral you make, so you can earn money while helping others discover the benefits of Crypto Trade Pro. To get started, simply copy your unique referral link below and share it with your family and friends. If you have any questions or need assistance, please don’t hesitate to contact our support team.
              </Typography>
              <TextField
                fullWidth
