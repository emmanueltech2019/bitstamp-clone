    ...
    return (
        ...
        {/* <GoogleTranslate/>  */}
            ...
            <header className='flex justify-between lg:px-[3.5rem] p-3 px-6 items-center fixed top-0 w-[100%] bg-[#f2f2f2] z-40'>
                <div className="logo">
                    <Link href="/hero">
                        <Image src={logo} alt="alt" className='w-[220px]' />
                    </Link>
                ...
                <div className="navList">
                    <ul className='gap-4 hidden text-[13px] font-light sm:hidden md:hidden lg:flex'>
                        ...
                        <li>Blog</li>
                        <li>Learn</li> */}
                        {/* <li className='lg:hidden'>Get Mirror Trade app</li> */}
                    </ul>
                </div>
                {
                ...
                <div className='flex gap-3 items-center text-[14px]'>
                    ...
                    <Link href='/register' className='text-[#F3F3F3]  bg-[#303841] p-[6px] px-5 rounded'>Get started</Link>
                    </div>
