...
function NavBar() {
    ...
    return (
        <div className=''>
            <header className='flex justify-between lg:justify-around p-3 px-6 items-center fixed top-0 w-[100%] bg-[#fff] shadow z-40'>
                <div className="logo">
                    <Image src={logo} alt="alt" className='w-[135px]' />
