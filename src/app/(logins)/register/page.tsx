...
// import logo from '../img/MirrorTradeX_logo-removebg-preview.png'
...
// // 6LdbWvEpAAAAAOC_iD8sPQYEZj701EZ0oLFH1LAV
// export default Page
...
function RegisterContent() {
    ...
    useEffect(() => {
        ...
        script.src = `https://www.google.com/recaptcha/api.js?render=6LdbWvEpAAAAAOC_iD8sPQYEZj701EZ0oLFH1LAV`;
        script.async = true;
